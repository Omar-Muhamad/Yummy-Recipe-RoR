...
RSpec.describe 'The page index page', type: :feature do
  describe 'after logging in' do
    before :each do
      ...
      @food1 = Food.create!(name: 'Test Food 1', measurement_unit: 'kg', price: 2, user_id: @user1.id)

      @food2 = Food.create!(name: 'Test Food 2', measurement_unit: 'kg', price: 1, user_id: @user1.id)
