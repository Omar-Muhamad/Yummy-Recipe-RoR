...
RSpec.describe 'The public recipes page', type: :feature do
    ...
    before :each do
      ...
      @recipe1 = Recipe.create!(name: 'Test Recipe 1', description: 'test decription 1', public: true, user_id: @user1.id)

      @recipe2 = Recipe.create!(name: 'Test Recipe 2', description: 'test decription 2', public: false, user_id: @user1.id)
    end
